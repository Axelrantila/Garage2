...
namespace Garage2.Controllers
{
    public class Vehicles2Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Owner,LicenseNr,TypeOfVehicle,MakeAndModel,Color,Length,Weight,NrOfWheels,TimeParked,Parked,ParkingLot")] Vehicle vehicle)
        {
